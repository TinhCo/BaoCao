    ...
    <div className='w-screen h-screen relative'>
      {isVerifiedEmail && <div className='absolute top-0 left-0 right-0 bottom-0 bg-overlay z-50 flex flex-col justify-center items-center'>
        <div className='bg-white w-[500px] rounded-md p-8'>
          <h4>We sent a code to your code mail. Please check  your mail and enter your code:</h4>
          <input type="text"
            value={token}
          ...
          <button
            type='button'
            className='px-4 py-2 bg-blue-500 font-semibold text-white rounded-md ml-6'
      ...
      />
      <div className='absolute w-full top-0 bottom-0  left-0 right-1/2 items-center justify-center flex'>
        <div className='p-8 bg-white  flex-col items-center rounded-md min-w-[450px]'>
